...
class ToyPropMyoController(opensim.simulation.Controller):
    ...
    __swig_setmethods__["PropertyIndex_socket_actuator_connectee_name"] = _examplecomponents.ToyPropMyoController_PropertyIndex_socket_actuator_connectee_name_set
    __swig_getmethods__["PropertyIndex_socket_actuator_connectee_name"] = _examplecomponents.ToyPropMyoController_PropertyIndex_socket_actuator_connectee_name_get
    if _newclass:
        PropertyIndex_socket_actuator_connectee_name = _swig_property(_examplecomponents.ToyPropMyoController_PropertyIndex_socket_actuator_connectee_name_get, _examplecomponents.ToyPropMyoController_PropertyIndex_socket_actuator_connectee_name_set)
    ...
    __swig_setmethods__["PropertyIndex_input_activation_connectee_name"] = _examplecomponents.ToyPropMyoController_PropertyIndex_input_activation_connectee_name_set
    __swig_getmethods__["PropertyIndex_input_activation_connectee_name"] = _examplecomponents.ToyPropMyoController_PropertyIndex_input_activation_connectee_name_get
    if _newclass:
        PropertyIndex_input_activation_connectee_name = _swig_property(_examplecomponents.ToyPropMyoController_PropertyIndex_input_activation_connectee_name_get, _examplecomponents.ToyPropMyoController_PropertyIndex_input_activation_connectee_name_set)
