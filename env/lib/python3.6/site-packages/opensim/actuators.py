...
class BodyActuator(opensim.simulation.Actuator):
    ...
    __swig_setmethods__["PropertyIndex_socket_body_connectee_name"] = _actuators.BodyActuator_PropertyIndex_socket_body_connectee_name_set
    __swig_getmethods__["PropertyIndex_socket_body_connectee_name"] = _actuators.BodyActuator_PropertyIndex_socket_body_connectee_name_get
    if _newclass:
        PropertyIndex_socket_body_connectee_name = _swig_property(_actuators.BodyActuator_PropertyIndex_socket_body_connectee_name_get, _actuators.BodyActuator_PropertyIndex_socket_body_connectee_name_set)
